...
export default function Transport() {
  ...
  const mapsSearchUrl = tripData.location
    ? `https://www.google.com/maps/search/public+transport/@${tripData.location.lat},${tripData.location.lon},14z`
    : "#";

  return (
    <div className="min-h-screen flex flex-col px-4 py-2 max-w-lg mx-auto animate-fade-in">
      <PageHeader title="Transport" subtitle={tripData.destination} />

      <main className="flex-1 space-y-4 pb-6">
        <NeonCard padding="sm">
          <p className="text-sm text-muted-foreground">
            Transport-information kan ikke verificeres automatisk. Brug de
            officielle links nedenfor.
          </p>
        </NeonCard>
          ...
          <NeonCard variant="interactive" className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Se offentlig transport i området
                </p>
              </div>
            </div>
            <a
        ...
        <NeonCard padding="sm">
          <p className="text-xs text-muted-foreground">
            <strong>Bemærk:</strong> Køreplaner og priser verificeres ikke
            automatisk. Tjek altid de officielle kilder før booking.
          </p>
        </NeonCard>
      </main>
    </div>
